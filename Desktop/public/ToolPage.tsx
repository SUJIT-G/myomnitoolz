    ...
    const loadData = async () => {
      ...
      if (user) {
        ...
        try {
          ...
          if (err.code === 'unavailable' || err.code === 'unauthenticated' || err.message.includes('client is offline')) {
              setIsOnline(false);
    ...
    switch (tool.id) {
        ...
        case 'fh2': {
            ...
            const stopMonitoring = () => {
             ...
             return (
                 <div>
                    <video ref={videoRef} autoPlay className={`w-full rounded-lg bg-slate-200 mb-4 ${!monitoring && 'hidden'}`}></video>
